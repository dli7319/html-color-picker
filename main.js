...
`;class It extends Event{constructor(t){super(It.eventName,{bubbles:!0,composed:!0}),this.color=t}}It.eventName="set-color";class Dt extends Event{constructor(t){super(Dt.eventName,{bubbles:!0,composed:!0}),this.active=t}}Dt.eventName="set-interpolation-active";let Gt=class extends nt{constructor(){super(...arguments),this.typeName="",this.type="RGB"}};t([ht()],Gt.prototype,"typeName",void 0),t([ht()],Gt.prototype,"type",void 0),Gt=t([at("color-interpolation-gradient")],Gt);let Ft=class extends nt{constructor(){super(...arguments),this.position=0,this.color="#ffffff"}render(){return this.style.left=`${this.position}%`,G`
  ...
  `,t([ht({type:Number})],Ft.prototype,"position",void 0),t([ht({type:String})],Ft.prototype,"color",void 0),Ft=t([at("color-bar-pointer")],Ft),function(t){t.LEFT="left",t.RIGHT="right",t.NONE="none"}(jt||(jt={}));let Vt=class extends nt{constructor(){super(...arguments),this.activeColor=jt.NONE,this.leftColor=new zt({}),this.rightColor=new zt({}),this.activeLerpMode=null,this.activeRatio=.5,this.colorGradient=new Ot,this.onMouseMoveBound=this.onMouseMove.bind(this),this.onMouseUpBound=this.onMouseUp.bind(this),this.selectedGolorGradientDiv=null}setColor(t){this.dispatchEvent(new It(t))}setActiveColor(t){this.dispatchEvent(new Dt(t))}setActiveColorLeft(){this.setActiveColor(this.activeColor==jt.LEFT?jt.NONE:jt.LEFT)}setActiveColorRight(){this.setActiveColor(this.activeColor==jt.RIGHT?jt.NONE:jt.RIGHT)}onMouseMove(t){if(this.selectedGolorGradientDiv instanceof HTMLDivElement){const e=this.selectedGolorGradientDiv.getAttribute("data-mode")||"",o=this.selectedGolorGradientDiv.getBoundingClientRect(),i=Lt((t.clientX-o.left)/o.width,0,1),r=Rt[e.toUpperCase()],n=this.colorGradient.getColorAt(i,r);this.activeRatio=i,this.activeLerpMode=e,this.setActiveColor(jt.NONE),this.setColor(n)}}onMouseDown(t){this.selectedGolorGradientDiv=t.currentTarget;const e=this.selectedGolorGradientDiv.getAttribute("data-mode")||"",o=this.selectedGolorGradientDiv.getBoundingClientRect(),i=Lt((t.clientX-o.left)/o.width,0,1),r=Rt[e.toUpperCase()],n=this.colorGradient.getColorAt(i,r);this.activeRatio=i,this.activeLerpMode=e,this.setActiveColor(jt.NONE),this.setColor(n),document.addEventListener("mousemove",this.onMouseMoveBound),document.addEventListener("mouseup",this.onMouseUpBound)}onMouseUp(){document.removeEventListener("mousemove",this.onMouseMoveBound),document.removeEventListener("mouseup",this.onMouseUpBound),this.selectedGolorGradientDiv=null}render(){return this.colorGradient=new Ot(this.leftColor,this.rightColor),G`
      ...
      <div class="flex flex-col gap-2 mt-3">
        ${Array.prototype.map.call(this.children,(t=>{if(t instanceof Gt){const e=Rt[t.type],o=this.activeLerpMode===e,i=o?"#"+this.colorGradient.getColorAt(this.activeRatio,Rt[e.toUpperCase()]).getHex():"#ffffff";return G`
    ...
    `}};Vt.styles=[Ut,Nt],t([ht()],Vt.prototype,"activeColor",void 0),t([ht({attribute:!1})],Vt.prototype,"leftColor",void 0),t([ht({attribute:!1})],Vt.prototype,"rightColor",void 0),t([dt()],Vt.prototype,"activeLerpMode",void 0),t([dt()],Vt.prototype,"activeRatio",void 0),Vt=t([at("color-interpolation")],Vt);const Wt=s`:host {
  width: 100%;
  flex: 1;
}
...
.color-bar {
  ...
  background: linear-gradient(in hsl to right,
      ...
      #f0f 83%,
      #f00 100%);
}`;let Yt=class extends nt{constructor(){super(...arguments),this.hue=0}render(){const t="#"+new zt({type:Bt.HSV,h:this.hue,s:100,v:100}).getHex();return G`
      <color-bar-pointer
    ...
    `],t([ht({attribute:!1})],Zt.prototype,"color",void 0),t([pt("#color-grad-container")],Zt.prototype,"colorGradContainer",void 0),Zt=t([at("color-selection-type-a-grad")],Zt);let Jt=class extends nt{constructor(){super(...arguments),this.color=new zt}render(){return G`
    ...
    `],t([ht({attribute:!1})],Qt.prototype,"color",void 0),t([pt("#color-grad")],Qt.prototype,"colorGrad",void 0),Qt=t([at("color-selection-type-b-wheel")],Qt);let te=class extends nt{constructor(){super(...arguments),this.color=new zt}render(){const[,,t]=this.color.getHSL(),e="#"+this.color.getHex();return G`
      <color-bar-pointer
        .position=${t}
        .color=${e}
      ></color-bar-pointer>
  ...
  `,t([ht({attribute:!1})],ee.prototype,"color",void 0),t([pt("#color-bar")],ee.prototype,"colorBar",void 0),ee=t([at("color-selection-type-b-bar")],ee);let oe=class extends nt{constructor(){super(...arguments),this.color=new zt}render(){return G`
 ...
 */const Zo=Yo(class extends Ko{constructor(t){if(super(t),t.type!==qo||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const o=t.element.classList;for(const t of this.st)t in e||(o.remove(t),this.st.delete(t));for(const t in e){const i=!!e[t];i===this.st.has(t)||this.nt?.has(t)||(i?(o.add(t),this.st.add(t)):(o.remove(t),this.st.delete(t)))}return F}});function Jo(t){return function(t){for(let e=t;e;e=Qo(e))if(e instanceof Element&&"none"===getComputedStyle(e).display)return null;for(let e=Qo(t);e;e=Qo(e)){if(!(e instanceof Element))continue;const t=getComputedStyle(e);if("contents"!==t.display){if("static"!==t.position||go(t))return e;if("BODY"===e.tagName)return e}}return null}(t)}function Qo(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}var ti=class extends Pe{constructor(){super(...arguments),this.localize=new ye(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const t=this.anchorEl.getBoundingClientRect(),e=this.popup.getBoundingClientRect();let o=0,i=0,r=0,n=0,s=0,a=0,l=0,c=0;this.placement.includes("top")||this.placement.includes("bottom")?t.top<e.top?(o=t.left,i=t.bottom,r=t.right,n=t.bottom,s=e.left,a=e.top,l=e.right,c=e.top):(o=e.left,i=e.bottom,r=e.right,n=e.bottom,s=t.left,a=t.top,l=t.right,c=t.top):t.left<e.left?(o=t.right,i=t.top,r=e.left,n=e.top,s=t.right,a=t.bottom,l=e.left,c=e.bottom):(o=e.right,i=e.top,r=t.left,n=t.top,s=e.right,a=e.bottom,l=t.left,c=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${i}px`),this.style.setProperty("--hover-bridge-top-right-x",`${r}px`),this.style.setProperty("--hover-bridge-top-right-y",`${n}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${s}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${a}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${l}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${c}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){const t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else this.anchor instanceof Element||function(t){return null!==t&&"object"==typeof t&&"getBoundingClientRect"in t&&(!("contextElement"in t)||t instanceof Element)}(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&this.active&&(this.cleanup=Io(this.anchorEl,this.popup,(()=>{this.reposition()})))}async stop(){return new Promise((t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame((()=>t()))):t()}))}reposition(){if(!this.active||!this.anchorEl)return;const t=[Do({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(jo({apply:({rects:t})=>{const e="width"===this.sync||"both"===this.sync,o="height"===this.sync||"both"===this.sync;this.popup.style.width=e?`${t.reference.width}px`:"",this.popup.style.height=o?`${t.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&t.push(Fo({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(Go({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?t.push(jo({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:t,availableHeight:e})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${e}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${t}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push(Vo({element:this.arrowEl,padding:this.arrowPadding}));const e="absolute"===this.strategy?t=>No.getOffsetParent(t,Jo):No.getOffsetParent;Wo(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.strategy,platform:Re(Be({},No),{getOffsetParent:e})}).then((({x:t,y:e,middlewareData:o,placement:i})=>{const r="rtl"===this.localize.dir(),n={top:"bottom",right:"left",bottom:"top",left:"right"}[i.split("-")[0]];if(this.setAttribute("data-current-placement",i),Object.assign(this.popup.style,{left:`${t}px`,top:`${e}px`}),this.arrow){const t=o.arrow.x,e=o.arrow.y;let i="",s="",a="",l="";if("start"===this.arrowPlacement){const o="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";i="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",s=r?o:"",l=r?"":o}else if("end"===this.arrowPlacement){const o="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";s=r?"":o,l=r?o:"",a="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(l="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":"",i="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":""):(l="number"==typeof t?`${t}px`:"",i="number"==typeof e?`${e}px`:"");Object.assign(this.arrowEl.style,{top:i,right:s,bottom:a,left:l,[n]:"calc(var(--arrow-size-diagonal) * -1)"})}})),requestAnimationFrame((()=>this.updateHoverBridge())),this.emit("sl-reposition")}render(){return G`
    ...
    `}};pi.styles=[xe,se],pi.dependencies={"sl-popup":ti},He([pt("slot:not([name])")],pi.prototype,"defaultSlot",2),He([pt(".tooltip__body")],pi.prototype,"body",2),He([pt("sl-popup")],pi.prototype,"popup",2),He([ht()],pi.prototype,"content",2),He([ht()],pi.prototype,"placement",2),He([ht({type:Boolean,reflect:!0})],pi.prototype,"disabled",2),He([ht({type:Number})],pi.prototype,"distance",2),He([ht({type:Boolean,reflect:!0})],pi.prototype,"open",2),He([ht({type:Number})],pi.prototype,"skidding",2),He([ht()],pi.prototype,"trigger",2),He([ht({type:Boolean})],pi.prototype,"hoist",2),He([di("open",{waitUntilFirstUpdate:!0})],pi.prototype,"handleOpenChange",1),He([di(["content","distance","hoist","placement","skidding"])],pi.prototype,"handleOptionsChange",1),He([di("disabled")],pi.prototype,"handleDisabledChange",1),ri("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}}),ri("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});var ui=s`
  :host {
 ...
 */var $i,ki=Symbol(),Ci=Symbol(),Mi=new Map,Si=class extends Pe{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var o;let i;if(null==e?void 0:e.spriteSheet)return this.svg=G`<svg part="svg">
    ...
    `}};Ei.styles=[xe,ui],Ei.dependencies={"sl-icon":Si,"sl-tooltip":pi},He([pt('slot[name="copy-icon"]')],Ei.prototype,"copyIcon",2),He([pt('slot[name="success-icon"]')],Ei.prototype,"successIcon",2),He([pt('slot[name="error-icon"]')],Ei.prototype,"errorIcon",2),He([pt("sl-tooltip")],Ei.prototype,"tooltip",2),He([dt()],Ei.prototype,"isCopying",2),He([dt()],Ei.prototype,"status",2),He([ht()],Ei.prototype,"value",2),He([ht()],Ei.prototype,"from",2),He([ht({type:Boolean,reflect:!0})],Ei.prototype,"disabled",2),He([ht({attribute:"copy-label"})],Ei.prototype,"copyLabel",2),He([ht({attribute:"success-label"})],Ei.prototype,"successLabel",2),He([ht({attribute:"error-label"})],Ei.prototype,"errorLabel",2),He([ht({attribute:"feedback-duration",type:Number})],Ei.prototype,"feedbackDuration",2),He([ht({attribute:"tooltip-placement"})],Ei.prototype,"tooltipPlacement",2),He([ht({type:Boolean})],Ei.prototype,"hoist",2),ri("copy.in",{keyframes:[{scale:".25",opacity:".25"},{scale:"1",opacity:"1"}],options:{duration:100}}),ri("copy.out",{keyframes:[{scale:"1",opacity:"1"},{scale:".25",opacity:"0"}],options:{duration:100}}),Ei.define("sl-copy-button");class Ai extends Event{constructor(t,e){super(Ai.type,{bubbles:!0,composed:!0}),this.inputType=t,this.value=e}}Ai.type="color-converter-input",function(t){t.HEX="HEX",t.RGB255="RGB255",t.RGB01="RGB01",t.HSV="HSV",t.HSL="HSL"}(_i||(_i={}));const Li={[_i.HEX]:"Hex",[_i.RGB255]:"RGB (0-255)",[_i.RGB01]:"RGB (0-1)",[_i.HSV]:"HSV",[_i.HSL]:"HSL"},Bi={[_i.HEX]:"hexValue",[_i.RGB255]:"rgb255Value",[_i.RGB01]:"rgb01Value",[_i.HSV]:"hsvValue",[_i.HSL]:"hslValue"},Ri={[_i.HEX]:t=>"#"+t.getHex(),[_i.RGB255]:t=>t.getRGB255().splice(0,3).toString(),[_i.RGB01]:t=>t.getRGB01().splice(0,3).map((t=>t.toFixed(3))).toString(),[_i.HSV]:t=>t.getHSV(!1).splice(0,3).toString(),[_i.HSL]:t=>t.getHSL(!1).splice(0,3).toString()};let Hi=class extends nt{constructor(){super(...arguments),this.type=_i.HEX,this.inputValues={},this.color=new zt}onValueChange(t){this.dispatchEvent(new Ai(this.type,t.target.value))}render(){const t=this.inputValues[Bi[this.type]]??Ri[this.type](this.color);return G`
    ...
    `}};Hi.styles=[Ut],t([ht()],Hi.prototype,"type",void 0),t([ht({attribute:!1})],Hi.prototype,"inputValues",void 0),t([ht({attribute:!1})],Hi.prototype,"color",void 0),Hi=t([at("color-converter-input")],Hi);const zi=/^#?([0-9a-fA-F]{3}(?:[0-9a-fA-F]{3})?)$/,Pi=/^(\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})$/,Ti=/^([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?),+\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?),+\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?)$/,Oi=/^([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?),+\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?),+\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?)$/;const Ni={[_i.HEX]:function(t){const e=zi.exec(t);return e&&2==e.length?new zt({type:Bt.HEX,hex:e[1]}):null},[_i.RGB255]:function(t){const e=Pi.exec(t);return e&&4==e.length?new zt({type:Bt.RGB255,r:parseInt(e[1]),g:parseInt(e[2]),b:parseInt(e[3])}):null},[_i.RGB01]:function(t){const e=Ti.exec(t);return e&&4==e.length?new zt({type:Bt.RGB01,r:parseFloat(e[1]),g:parseFloat(e[2]),b:parseFloat(e[3])}):null},[_i.HSV]:function(t){const e=Oi.exec(t);if(e&&4==e.length){const t=parseFloat(e[1]),o=parseFloat(e[2]),i=parseFloat(e[3]);if(0<=t&&t<=360&&0<=o&&o<=100&&0<=i&&i<=100)return new zt({type:Bt.HSV,h:parseFloat(e[1]),s:parseFloat(e[2]),v:parseFloat(e[3])})}return null},[_i.HSL]:function(t){const e=Oi.exec(t);if(e&&4==e.length){const t=parseFloat(e[1]),o=parseFloat(e[2]),i=parseFloat(e[3]);if(0<=t&&t<=360&&0<=o&&o<=100&&0<=i&&i<=100)return new zt({type:Bt.HSL,h:parseFloat(e[1]),s:parseFloat(e[2]),v:parseFloat(e[3])})}return null}};let Ui=class extends nt{constructor(){super(),this.color=new zt,this.coordinates={x:0,y:0,width:0,height:0},this.inputValues={},this.addEventListener(Ai.type,(t=>{if(t instanceof Ai){const{inputType:e,value:o}=t,i=Ni[e](o);null!=i&&(this.setColor(i),this.inputValues={[Bi[e]]:o})}}))}setColor(t){this.dispatchEvent(new It(t))}updateChildren(){Array.prototype.forEach.call(this.children,(t=>{t instanceof Hi&&(t.inputValues=this.inputValues,t.color=this.color)}))}render(){const t={x:this.coordinates.x/this.coordinates.width,y:this.coordinates.y/this.coordinates.height},e=[t.x.toFixed(3),t.y.toFixed(3)],o=[Math.round(this.coordinates.x),Math.round(this.coordinates.y)];return this.updateChildren(),G`
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ii=(t,e)=>{const o=t._$AN;if(void 0===o)return!1;for(const t of o)t._$AO?.(e,!1),Ii(t,e);return!0},Di=t=>{let e,o;do{if(void 0===(e=t._$AM))break;o=e._$AN,o.delete(t),t=e}while(0===o?.size)},Gi=t=>{for(let e;e=t._$AM;t=e){let o=e._$AN;if(void 0===o)e._$AN=o=new Set;else if(o.has(t))break;o.add(t),Vi(e)}};function Fi(t){void 0!==this._$AN?(Di(this),this._$AM=t,Gi(this)):this._$AM=t}function ji(t,e=!1,o=0){const i=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(e)if(Array.isArray(i))for(let t=o;t<i.length;t++)Ii(i[t],!1),Di(i[t]);else null!=i&&(Ii(i,!1),Di(i));else Ii(this,t)}const Vi=t=>{t.type==Xo&&(t._$AP??=ji,t._$AQ??=Fi)};class Wi extends Ko{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,o){super._$AT(t,e,o),Gi(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(Ii(this,t),Di(this))}setValue(t){if((t=>void 0===t.strings)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Zi,Ji;!function(t){t.Transparent="transparent",t.Black="black",t.White="white"}(Zi||(Zi={})),function(t){t.Small="small",t.Medium="medium",t.Large="large"}(Ji||(Ji={}));const Qi={[Ji.Small]:"1rem",[Ji.Medium]:"1.5rem",[Ji.Large]:"3rem"};let tr=class extends nt{constructor(){super(),this.coordinates={x:0,y:0,width:0,height:0},this.initialOverlayColor=Zi.Black,this.overlayColor=Zi.Black,this.overlaySize=Ji.Medium,this.loadedImage=!1,this.canvasRef=new qi,this.overlayColor=this.initialOverlayColor}setColor(t){this.dispatchEvent(new It(t))}setCoordinates(t){this.dispatchEvent(new qt(t))}loadImage(t){const e=t.currentTarget.files?.item(0);if(e){const t=new FileReader;t.onload=t=>{const e=new Image;e.onload=()=>{const t=this.canvasRef.value,o=t.getContext("2d");o&&(t.width=e.width,t.height=e.height,o.drawImage(e,0,0)),this.loadedImage=!0},e.src=t.target?.result},t.readAsDataURL(e)}}sampleImage(t){if(t instanceof MouseEvent&&1==t.buttons){const e=this.canvasRef.value,o=e.getContext("2d");if(o){const i=e.getBoundingClientRect(),r=(t.clientX-i.left)/i.width*e.width,n=(t.clientY-i.top)/i.height*e.height,s=o.getImageData(r,n,1,1);this.setColor(new zt({type:Bt.RGB255,r:s.data[0],g:s.data[1],b:s.data[2]})),this.setCoordinates({x:r,y:n,width:e.width,height:e.height})}}}selectOverlayColor(t){this.overlayColor=t.currentTarget.value}selectOverlaySize(t){this.overlaySize=t.currentTarget.value}render(){const t=this.coordinates.x/this.coordinates.width*100,e=this.coordinates.y/this.coordinates.height*100,o=`\n      border-color: ${this.overlayColor};\n      top: calc(${e}% - var(--circle-diameter) / 2);\n      left: calc(${t}% - var(--circle-diameter) / 2);\n      --circle-diameter: ${Qi[this.overlaySize]};\n    `;return G`
    ...
    `}};tr.styles=[Ut,Ki],t([ht({attribute:!1})],tr.prototype,"coordinates",void 0),t([ht({attribute:!1})],tr.prototype,"initialOverlayColor",void 0),t([dt()],tr.prototype,"overlayColor",void 0),t([dt()],tr.prototype,"overlaySize",void 0),t([dt()],tr.prototype,"loadedImage",void 0),tr=t([at("image-sampling")],tr);class er extends nt{constructor(){super(...arguments),this.color=new zt,this.onMouseMoveBound=this.onMouseMove.bind(this),this.onMouseUpBound=this.onMouseUp.bind(this)}getColorMapData(){return[[0,0,0]]}getColorMapName(){return"Color Map"}setColor(t){this.dispatchEvent(new It(t))}toCss(){const t=this.getColorMapData(),e=[];for(let o=0;o<256;o++)e.push(`rgba(${Math.round(255*t[o][0])}, ${Math.round(255*t[o][1])}, ${Math.round(255*t[o][2])}, 255) ${100*o/255}%`);return`linear-gradient(to right, ${e.join(", ")})`}getColorAt(t){const e=this.getColorMapData(),o=Math.floor(Lt(t*e.length,0,e.length-1)),i=Math.ceil(Lt(t*e.length,0,e.length-1)),r=t*e.length-o;return Tt(new zt({type:Bt.RGB01,r:e[o][0],g:e[o][1],b:e[o][2]}),new zt({type:Bt.RGB01,r:e[i][0],g:e[i][1],b:e[i][2]}),r)}findClosestColormapPoint(t){const e=t.getRGB255(),o=this.getColorMapData();let i=1/0,r=0;for(let t=0;t<o.length;t++){const n=Math.round(255*o[t][0]),s=Math.round(255*o[t][1]),a=Math.round(255*o[t][2]),l=e[0]-n,c=e[1]-s,h=e[2]-a,d=Math.sqrt(l*l+c*c+h*h);d<i&&(i=d,r=t)}return{index:r,distance:i,ratio:o.length>1?r/(o.length-1):0}}onMouseMove(t){if(1==t.buttons){const e=this.colorMapDiv.getBoundingClientRect(),o=Lt((t.clientX-e.left)/e.width,0,1),i=this.getColorAt(o);this.setColor(i)}}onMouseDown(t){const e=this.colorMapDiv.getBoundingClientRect(),o=Lt((t.clientX-e.left)/e.width,0,1),i=this.getColorAt(o);this.setColor(i),document.addEventListener("mousemove",this.onMouseMoveBound),document.addEventListener("mouseup",this.onMouseUpBound)}onMouseUp(){document.removeEventListener("mousemove",this.onMouseMoveBound),document.removeEventListener("mouseup",this.onMouseUpBound)}render(){const t=this.findClosestColormapPoint(this.color),e=t.distance<=30;return G`
    ...
    `}};sr.styles=[Ut],sr=t([at("other-tools")],sr);let ar=class extends nt{constructor(){super(),this.color=new zt({type:Bt.RGB255,r:71,g:85,b:105}),this.coordinates={x:0,y:0,width:1,height:1},this.interpolationLeft=new zt({type:Bt.RGB255,r:255,g:0,b:0}),this.interpolationRight=new zt({type:Bt.RGB255,r:255,g:255,b:255}),this.interpolationActive=jt.NONE,this.addEventListener(It.eventName,(t=>{t instanceof It&&this.setColor(t.color)})),this.addEventListener(qt.eventName,(t=>{t instanceof qt&&this.setCoordinates(t.coordinates)})),this.addEventListener(Dt.eventName,(t=>{t instanceof Dt&&this.setInterpolationActive(t.active)}))}setColor(t){this.color=t,this.interpolationActive===jt.LEFT?this.interpolationLeft=t:this.interpolationActive==jt.RIGHT&&(this.interpolationRight=t)}setCoordinates(t){this.coordinates=t}setInterpolationActive(t){this.interpolationActive=t}updateChildren(){Array.prototype.forEach.call(this.children,(t=>{t instanceof re?t.color=this.color:t instanceof Ui?(t.color=this.color,t.coordinates=this.coordinates):t instanceof tr?t.coordinates=this.coordinates:t instanceof Vt?(t.leftColor=this.interpolationLeft,t.rightColor=this.interpolationRight,t.activeColor=this.interpolationActive):t instanceof rr&&(t.color=this.color)}))}render(){return this.style.background="#"+this.color.getHex(),this.updateChildren(),G`<slot class="main-container"></slot>`}};ar.styles=[Ut,Wt],t([dt()],ar.prototype,"color",void 0),t([dt()],ar.prototype,"coordinates",void 0),t([dt()],ar.prototype,"interpolationLeft",void 0),t([dt()],ar.prototype,"interpolationRight",void 0),t([dt()],ar.prototype,"interpolationActive",void 0),ar=t([at("color-picker")],ar);
