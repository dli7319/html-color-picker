  ...
  return (
    <div className={className}>
      ...
      <div className={styles.colorGradContainer}>
        <div
          className={`${styles.colorGrad} ${styles.colorGrad1}`}
          style={{
            background: colorGradStyleBackground,
          }}
        ></div>
        <div
          className={`${styles.colorGrad} ${styles.colorGrad2}`}
          onMouseMove={onMouseMoveColorGrad}
          onMouseDown={onMouseMoveColorGrad}
        ></div>
        <div className={styles.colorGradCircle} style={colorCircleStyle}></div>
      </div>
      <div
        className={styles.colorBar}
        onMouseMove={onMouseMoveColorBar}
        onMouseDown={onMouseMoveColorBar}
      >
        <div
          className={styles.colorBarPointer}
          style={{
        ...
        >
          ...
          <div
            className={styles.colorBarPointer3}
            style={{
              borderBottomColor: hueColorHex,
            }}
          ></div>
          <div
            className={styles.colorBarPointer4}
            style={{
