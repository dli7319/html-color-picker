...
`;class It extends Event{constructor(t){super(It.eventName,{bubbles:!0,composed:!0}),this.color=t}}It.eventName="set-color";class Dt extends Event{constructor(t){super(Dt.eventName,{bubbles:!0,composed:!0}),this.active=t}}Dt.eventName="set-interpolation-active";let Ft=class extends nt{constructor(){super(...arguments),this.typeName="",this.type="RGB"}};var Gt;t([ht()],Ft.prototype,"typeName",void 0),t([ht()],Ft.prototype,"type",void 0),Ft=t([at("color-interpolation-gradient")],Ft),function(t){t.LEFT="left",t.RIGHT="right",t.NONE="none"}(Gt||(Gt={}));let jt=class extends nt{constructor(){super(...arguments),this.activeColor=Gt.NONE,this.leftColor=new zt({}),this.rightColor=new zt({}),this.colorGradient=new Ot,this.onMouseMoveBound=this.onMouseMove.bind(this),this.onMouseUpBound=this.onMouseUp.bind(this),this.selectedGolorGradientDiv=null}setColor(t){this.dispatchEvent(new It(t))}setActiveColor(t){this.dispatchEvent(new Dt(t))}setActiveColorLeft(){this.setActiveColor(this.activeColor==Gt.LEFT?Gt.NONE:Gt.LEFT)}setActiveColorRight(){this.setActiveColor(this.activeColor==Gt.RIGHT?Gt.NONE:Gt.RIGHT)}onMouseMove(t){if(this.selectedGolorGradientDiv instanceof HTMLDivElement){const e=this.selectedGolorGradientDiv.getAttribute("data-mode")||"",o=this.selectedGolorGradientDiv.getBoundingClientRect(),i=(t.clientX-o.left)/o.width,r=this.colorGradient.getColorAt(i,Ht[e.toUpperCase()]);this.setActiveColor(Gt.NONE),this.setColor(r)}}onMouseDown(t){this.selectedGolorGradientDiv=t.currentTarget,document.addEventListener("mousemove",this.onMouseMoveBound),document.addEventListener("mouseup",this.onMouseUpBound)}onMouseUp(){document.removeEventListener("mousemove",this.onMouseMoveBound),document.removeEventListener("mouseup",this.onMouseUpBound),this.selectedGolorGradientDiv=null}render(){return this.colorGradient=new Ot(this.leftColor,this.rightColor),F`
      ...
      <div class="flex flex-col gap-2 mt-3">
        ${Array.prototype.map.call(this.children,(t=>{if(t instanceof Ft){const e=Ht[t.type];return F`
    ...
    `}};jt.styles=[Ut,Nt],t([ht()],jt.prototype,"activeColor",void 0),t([ht({attribute:!1})],jt.prototype,"leftColor",void 0),t([ht({attribute:!1})],jt.prototype,"rightColor",void 0),jt=t([at("color-interpolation")],jt);const Vt=s`:host {
  width: 100%;
  flex: 1;
}
...
.color-bar-pointer-4 {
    ...
    transform: translateX(-50%);
    top: 0.5em;
}`;let Yt=class extends nt{constructor(){super(...arguments),this.hue=0}render(){const t="#"+new zt({type:Bt.HSV,h:this.hue,s:100,v:100}).getHex(),e=this.hue/360*100+"%";return F`
    ...
    `],t([ht({attribute:!1})],Zt.prototype,"color",void 0),t([pt("#color-grad-container")],Zt.prototype,"colorGradContainer",void 0),Zt=t([at("color-selection-type-a-grad")],Zt);let Jt=class extends nt{constructor(){super(...arguments),this.color=new zt}render(){return F`
    ...
    `],t([ht({attribute:!1})],Qt.prototype,"color",void 0),t([pt("#color-grad")],Qt.prototype,"colorGrad",void 0),Qt=t([at("color-selection-type-b-wheel")],Qt);let te=class extends nt{constructor(){super(...arguments),this.color=new zt}render(){const[,,t]=this.color.getHSL(),e="#"+this.color.getHex();return F`
  ...
  `,t([ht({attribute:!1})],ee.prototype,"color",void 0),t([pt("#color-bar")],ee.prototype,"colorBar",void 0),ee=t([at("color-selection-type-b-bar")],ee);let oe=class extends nt{constructor(){super(...arguments),this.color=new zt}render(){return F`
    ...
    `],t([ht({attribute:!1})],oe.prototype,"color",void 0),oe=t([at("color-selection-type-b")],oe),function(t){t.HSV="HSV",t.HSL_WHEEL="HSL_WHEEL"}(ie||(ie={}));let re=class extends nt{constructor(){super(...arguments),this.color=new zt,this.colorSelectionType=ie.HSV}getColorSelectionHtml(){return this.colorSelectionType===ie.HSV?F`<color-selection-type-a
      ...
      ></color-selection-type-a>`:F`<color-selection-type-b
        ...
        .color=${this.color}
      ></color-selection-type-b>`}render(){const t=this.colorSelectionType===ie.HSV;return F`
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ii=(t,e)=>{const o=t._$AN;if(void 0===o)return!1;for(const t of o)t._$AO?.(e,!1),Ii(t,e);return!0},Di=t=>{let e,o;do{if(void 0===(e=t._$AM))break;o=e._$AN,o.delete(t),t=e}while(0===o?.size)},Fi=t=>{for(let e;e=t._$AM;t=e){let o=e._$AN;if(void 0===o)e._$AN=o=new Set;else if(o.has(t))break;o.add(t),Vi(e)}};function Gi(t){void 0!==this._$AN?(Di(this),this._$AM=t,Fi(this)):this._$AM=t}function ji(t,e=!1,o=0){const i=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(e)if(Array.isArray(i))for(let t=o;t<i.length;t++)Ii(i[t],!1),Di(i[t]);else null!=i&&(Ii(i,!1),Di(i));else Ii(this,t)}const Vi=t=>{t.type==Xo&&(t._$AP??=ji,t._$AQ??=Gi)};class Wi extends Ko{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,o){super._$AT(t,e,o),Fi(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(Ii(this,t),Di(this))}setValue(t){if((t=>void 0===t.strings)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Zi,Ji;!function(t){t.Transparent="transparent",t.Black="black",t.White="white"}(Zi||(Zi={})),function(t){t.Small="small",t.Medium="medium",t.Large="large"}(Ji||(Ji={}));const Qi={[Ji.Small]:"1rem",[Ji.Medium]:"1.5rem",[Ji.Large]:"3rem"};let tr=class extends nt{constructor(){super(),this.coordinates={x:0,y:0,width:0,height:0},this.initialOverlayColor=Zi.Black,this.overlayColor=Zi.Black,this.overlaySize=Ji.Medium,this.loadedImage=!1,this.canvasRef=new qi,this.overlayColor=this.initialOverlayColor}setColor(t){this.dispatchEvent(new It(t))}setCoordinates(t){this.dispatchEvent(new Wt(t))}loadImage(t){const e=t.currentTarget.files?.item(0);if(e){const t=new FileReader;t.onload=t=>{const e=new Image;e.onload=()=>{const t=this.canvasRef.value,o=t.getContext("2d");o&&(t.width=e.width,t.height=e.height,o.drawImage(e,0,0)),this.loadedImage=!0},e.src=t.target?.result},t.readAsDataURL(e)}}sampleImage(t){if(t instanceof MouseEvent&&1==t.buttons){const e=this.canvasRef.value,o=e.getContext("2d");if(o){const i=e.getBoundingClientRect(),r=(t.clientX-i.left)/i.width*e.width,n=(t.clientY-i.top)/i.height*e.height,s=o.getImageData(r,n,1,1);this.setColor(new zt({type:Bt.RGB255,r:s.data[0],g:s.data[1],b:s.data[2]})),this.setCoordinates({x:r,y:n,width:e.width,height:e.height})}}}selectOverlayColor(t){this.overlayColor=t.currentTarget.value}selectOverlaySize(t){this.overlaySize=t.currentTarget.value}render(){const t=this.coordinates.x/this.coordinates.width*100,e=this.coordinates.y/this.coordinates.height*100,o=`\n      border-color: ${this.overlayColor};\n      top: calc(${e}% - var(--circle-diameter) / 2);\n      left: calc(${t}% - var(--circle-diameter) / 2);\n      --circle-diameter: ${Qi[this.overlaySize]};\n    `;return F`
    ...
    `}};rr.styles=[Ut],rr=t([at("color-maps")],rr);let nr=class extends nt{constructor(){super(...arguments),this.name="",this.href=""}};t([ht()],nr.prototype,"name",void 0),t([ht()],nr.prototype,"href",void 0),nr=t([at("other-tools-entry")],nr);let sr=class extends nt{render(){return F`
      ...
      <ul class="list-disc list-inside text-left space-y-2 text-sm">
        ${Array.prototype.map.call(this.children,(t=>{if(t instanceof nr)return F`<li>
              <a class="text-blue-600 hover:text-blue-800 hover:underline font-medium" href="${t.href}" target="_blank">${t.name}</a>
            </li>`}))}
      </ul>
    `}};sr.styles=[Ut],sr=t([at("other-tools")],sr);let ar=class extends nt{constructor(){super(),this.color=new zt({type:Bt.RGB255,r:71,g:85,b:105}),this.coordinates={x:0,y:0,width:1,height:1},this.interpolationLeft=new zt({type:Bt.RGB255,r:255,g:0,b:0}),this.interpolationRight=new zt({type:Bt.RGB255,r:255,g:255,b:255}),this.interpolationActive=Gt.NONE,this.addEventListener(It.eventName,(t=>{t instanceof It&&this.setColor(t.color)})),this.addEventListener(Wt.eventName,(t=>{t instanceof Wt&&this.setCoordinates(t.coordinates)})),this.addEventListener(Dt.eventName,(t=>{t instanceof Dt&&this.setInterpolationActive(t.active)}))}setColor(t){this.color=t,this.interpolationActive===Gt.LEFT?this.interpolationLeft=t:this.interpolationActive==Gt.RIGHT&&(this.interpolationRight=t)}setCoordinates(t){this.coordinates=t}setInterpolationActive(t){this.interpolationActive=t}updateChildren(){Array.prototype.forEach.call(this.children,(t=>{t instanceof re?t.color=this.color:t instanceof Ui?(t.color=this.color,t.coordinates=this.coordinates):t instanceof tr?t.coordinates=this.coordinates:t instanceof jt&&(t.leftColor=this.interpolationLeft,t.rightColor=this.interpolationRight,t.activeColor=this.interpolationActive)}))}render(){return this.style.background="#"+this.color.getHex(),this.updateChildren(),F`<slot class="main-container"></slot>`}};ar.styles=[Ut,Vt],t([dt()],ar.prototype,"color",void 0),t([dt()],ar.prototype,"coordinates",void 0),t([dt()],ar.prototype,"interpolationLeft",void 0),t([dt()],ar.prototype,"interpolationRight",void 0),t([dt()],ar.prototype,"interpolationActive",void 0),ar=t([at("color-picker")],ar);
