...
`;class Ft extends Event{constructor(t){super(Ft.eventName,{bubbles:!0,composed:!0}),this.color=t}}Ft.eventName="set-color";class jt extends Event{constructor(t){super(jt.eventName,{bubbles:!0,composed:!0}),this.color=t}}jt.eventName="commit-color";class Vt extends Event{constructor(t){super(Vt.eventName,{bubbles:!0,composed:!0}),this.active=t}}Vt.eventName="set-interpolation-active";class Wt{constructor(t,e){this.options=e,this.handleMouseDown=t=>{this.options.onDragStart?.(t),document.addEventListener("mousemove",this.handleMouseMove),document.addEventListener("mouseup",this.handleMouseUp)},this.handleMouseMove=t=>{this.options.onDrag(t)},this.handleMouseUp=()=>{document.removeEventListener("mousemove",this.handleMouseMove),document.removeEventListener("mouseup",this.handleMouseUp),this.options.onDragEnd?.()},t.addController(this)}hostDisconnected(){document.removeEventListener("mousemove",this.handleMouseMove),document.removeEventListener("mouseup",this.handleMouseUp)}}let qt=class extends at{constructor(){super(...arguments),this.position=0,this.color="#ffffff"}updated(){this.style.left=`${this.position}%`}render(){return F`
      <div
...
.color-bar {
  ...
  background: linear-gradient(in hsl to right,
      ...
      #f0f 83%,
      #f00 100%);
}`;class te extends at{constructor(){super(...arguments),this.color=new Tt,this.lastCommittedColor=this.color}setColor(t){this.lastCommittedColor=t,this.dispatchEvent(new Ft(t))}commitColor(){this.dispatchEvent(new jt(this.lastCommittedColor))}}t([pt({attribute:!1})],te.prototype,"color",void 0);let ee=class extends te{constructor(){super(...arguments),this.drag=new Wt(this,{onDrag:t=>{const[,e,o]=this.color.getHSV(),i=this.colorBar.getBoundingClientRect(),r=360*Ot((t.clientX-i.left)/i.width,0,1);this.setColor(new Tt({type:Ht.HSV,h:r,s:e,v:o}))},onDragEnd:()=>{this.commitColor()}})}render(){const[t]=this.color.getHSV(),e="#"+new Tt({type:Ht.HSV,h:t,s:100,v:100}).getHex();return F`
      <div
        class="color-bar"
        @mousedown=${this.drag.handleMouseDown}
        id="color-bar"
 ...
 */;var Ii,zi=Symbol(),Ti=Symbol(),Pi=new Map,Ni=class extends Be{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var o;let i;if(null==e?void 0:e.spriteSheet)return this.svg=F`<svg part="svg">
    ...
    `}};Vi.styles=[Ut],t([pt()],Vi.prototype,"type",void 0),t([pt({attribute:!1})],Vi.prototype,"inputValues",void 0),t([pt({attribute:!1})],Vi.prototype,"color",void 0),Vi=t([ct("color-converter-input")],Vi);const Wi=/^#?([0-9a-fA-F]{3}(?:[0-9a-fA-F]{3})?)$/,qi=/^(\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})$/,Xi=/^([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?),+\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?),+\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?)$/,Yi=/^([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?),+\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?),+\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?)$/,Ji=/^([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?),+\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?),+\s*([-+]?\d*\.?\d+(?:[eE][-+]?\d+)?)$/;function Ki(t,e,o){for(const i of t.children)i instanceof e&&o(i)}const Zi={[Bi.HEX]:function(t){const e=Wi.exec(t);return e&&2===e.length?new Tt({type:Ht.HEX,hex:e[1]}):null},[Bi.RGB255]:function(t){const e=qi.exec(t);if(e&&4===e.length){const t=parseInt(e[1]),o=parseInt(e[2]),i=parseInt(e[3]);if(0<=t&&t<=255&&0<=o&&o<=255&&0<=i&&i<=255)return new Tt({type:Ht.RGB255,r:t,g:o,b:i})}return null},[Bi.RGB01]:function(t){const e=Xi.exec(t);if(e&&4===e.length){const t=parseFloat(e[1]),o=parseFloat(e[2]),i=parseFloat(e[3]);if(0<=t&&t<=1&&0<=o&&o<=1&&0<=i&&i<=1)return new Tt({type:Ht.RGB01,r:t,g:o,b:i})}return null},[Bi.HSV]:function(t){const e=Yi.exec(t);if(e&&4===e.length){const t=parseFloat(e[1]),o=parseFloat(e[2]),i=parseFloat(e[3]);if(0<=t&&t<=360&&0<=o&&o<=100&&0<=i&&i<=100)return new Tt({type:Ht.HSV,h:parseFloat(e[1]),s:parseFloat(e[2]),v:parseFloat(e[3])})}return null},[Bi.HSL]:function(t){const e=Ji.exec(t);if(e&&4===e.length){const t=parseFloat(e[1]),o=parseFloat(e[2]),i=parseFloat(e[3]);if(0<=t&&t<=360&&0<=o&&o<=100&&0<=i&&i<=100)return new Tt({type:Ht.HSL,h:parseFloat(e[1]),s:parseFloat(e[2]),l:parseFloat(e[3])})}return null}};let Qi=class extends at{constructor(){super(),this.color=new Tt,this.coordinates={x:0,y:0,width:0,height:0},this.inputValues={},this.addEventListener(Gi.eventName,t=>{if(t instanceof Gi){const{inputType:e,value:o}=t,i=Zi[e](o);null!=i&&(this.setColor(i),this.dispatchEvent(new jt(i)),this.inputValues={[Fi[e]]:o})}})}setColor(t){this.dispatchEvent(new Ft(t))}updateChildren(){Ki(this,Vi,t=>{t.inputValues=this.inputValues,t.color=this.color})}updated(){this.updateChildren()}render(){const{width:t,height:e}=this.coordinates,o=t||1,i=e||1,r={x:this.coordinates.x/o,y:this.coordinates.y/i},n=[r.x.toFixed(3),r.y.toFixed(3)],s=[Math.round(this.coordinates.x),Math.round(this.coordinates.y)];return F`
...
`,Rr="color-palette-store";let Or=class extends at{constructor(){super(),this.activeEditingColor=new Tt,this.colors=[],this.locked=Array(5).fill(!1),this.activeIndex=-1,this.paletteMode=yr.ANY,this.paletteCount=5,this.narrow=!1,this.dragIndex=-1,this.dragOverIndex=-1,this.prevEditingColor=null,this.resizeObserver=null,this.handleSpacebar=t=>{const e=t.target.tagName;"Space"===t.code&&"INPUT"!==e&&"TEXTAREA"!==e&&(t.preventDefault(),this.regenerate())};const t=this.loadFromStorage();t?(this.colors=t.colors,this.locked=t.locked,this.paletteMode=t.mode,this.paletteCount=t.count):this.colors=_r({count:this.paletteCount})}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.handleSpacebar),this.resizeObserver=new ResizeObserver(t=>{const e=t[0]?.contentRect.width??0;this.narrow=e<448}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.handleSpacebar),this.resizeObserver?.disconnect()}updated(){this.activeIndex>=0&&this.activeEditingColor!==this.prevEditingColor&&this.colors[this.activeIndex]!==this.activeEditingColor&&(this.colors[this.activeIndex]=this.activeEditingColor,this.colors=[...this.colors],this.saveToStorage()),this.prevEditingColor=this.activeEditingColor}regenerate(){this.colors=_r({count:this.paletteCount,mode:this.paletteMode},this.locked,this.colors),this.saveToStorage(),this.activeIndex>=0&&this.dispatchEvent(new Ft(this.colors[this.activeIndex]))}copyColor(t){navigator.clipboard.writeText("#"+t.getHex()).catch(()=>{})}regenerateSwatch(t,e){e.stopPropagation();const o=_r({count:1,mode:this.paletteMode})[0];this.colors[t]=o,this.colors=[...this.colors],this.dispatchEvent(new Ft(o)),this.dispatchEvent(new jt(o)),this.saveToStorage()}selectSwatch(t){if(this.activeIndex===t)return this.activeIndex=-1,void this.dispatchEvent(new Mr(-1));this.activeIndex=t,this.dispatchEvent(new Ft(this.colors[t])),this.dispatchEvent(new Mr(t)),this.dispatchEvent(new jt(this.colors[t]))}setMode(t){this.paletteMode=t,this.saveToStorage(),this.regenerate()}setCount(t){if(t!==this.paletteCount){if(this.paletteCount=t,t>this.colors.length){const e=_r({count:t-this.colors.length,mode:this.paletteMode});this.colors=[...this.colors,...e],this.locked=[...this.locked,...Array(t-this.locked.length).fill(!1)]}else this.colors=this.colors.slice(0,t),this.locked=this.locked.slice(0,t),this.activeIndex>=t&&(this.activeIndex=-1,this.dispatchEvent(new Mr(-1)));this.colors=[...this.colors],this.locked=[...this.locked],this.saveToStorage(),this.regenerate()}}toggleLock(t,e){e.stopPropagation(),this.locked[t]=!this.locked[t],this.locked=[...this.locked],this.saveToStorage()}onDragStart(t,e){this.dragIndex=t,e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",String(t))}onDragOver(t,e){e.preventDefault(),e.dataTransfer.dropEffect="move",this.dragOverIndex=t}onDragLeave(){this.dragOverIndex=-1}onDrop(t){const e=this.dragIndex;if(e<0||e===t)return;const o=[...this.colors],i=[...this.locked],[r]=o.splice(e,1),[n]=i.splice(e,1);o.splice(t,0,r),i.splice(t,0,n),this.colors=o,this.locked=i,this.activeIndex===e?this.activeIndex=t:this.activeIndex>=0&&(this.activeIndex=o.indexOf(this.colors[this.activeIndex])),this.saveToStorage()}onDragEnd(){this.dragIndex=-1,this.dragOverIndex=-1}saveToStorage(){try{const t={colors:this.colors.map(t=>({hex:t.getHex()})),locked:this.locked,mode:this.paletteMode,count:this.paletteCount};localStorage.setItem(Rr,JSON.stringify(t))}catch{}}loadFromStorage(){try{const t=localStorage.getItem(Rr);if(!t)return null;const e=JSON.parse(t);if(!e.colors||!e.colors.length)return null;const o=e.count??e.colors.length;return{colors:e.colors.map(t=>new Tt({type:Ht.HEX,hex:t.hex})),locked:e.locked??Array(o).fill(!1),mode:e.mode??yr.ANY,count:o}}catch{return null}}render(){return F`
...
`,Ir="color-history-store";let zr=class extends at{constructor(){super(),this.history=[],this.activeIndex=-1,this.handleCommit=t=>{if(!(t instanceof jt))return;const e=this.closest("color-picker");if(!e||!e.contains(t.target))return;const o=t.color.getHex();this.history.length>0&&this.history[0].getHex()===o||(this.history=[t.color,...this.history].slice(0,50),this.activeIndex=-1,this.saveToStorage(),this.saveLastColor(t.color))},this.history=this.loadFromStorage()}connectedCallback(){super.connectedCallback(),window.addEventListener(jt.eventName,this.handleCommit)}saveLastColor(t){try{localStorage.setItem("last-active-color",t.getHex())}catch{}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(jt.eventName,this.handleCommit)}selectSwatch(t,e){this.activeIndex=t,this.dispatchEvent(new Ft(e)),this.saveLastColor(e)}clearHistory(){this.history=[],this.activeIndex=-1,this.saveToStorage()}saveToStorage(){try{const t=this.history.map(t=>({hex:t.getHex()}));localStorage.setItem(Ir,JSON.stringify(t))}catch{}}loadFromStorage(){try{const t=localStorage.getItem(Ir);if(!t)return[];const e=JSON.parse(t);return Array.isArray(e)?e.map(t=>new Tt({type:Ht.HEX,hex:t.hex})):[]}catch{return[]}}render(){return F`
